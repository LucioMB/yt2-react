...
import {
    ...
    Iscrizione7,
    Iscrizione8
} from "./images/indexArticleBar.js";
import { videosLoaded } from "./actions/videos";
...
function ArticleBar() {
    ...
    useEffect(() => {
        fetch("http://localhost:8081/videos")
            .then(res => res.json())
            .then(json => {
                const action = videosLoaded(json.videos);
                dispatch(action);
            });
    }, [dispatch]);
    ...
    return (
        <div id="main-article">
            <article>
                <h4 class="title-art">Caricati dal BE</h4>
                <div class="video-col">
                    {videos.map((v, i) => (
                        <div key={v.name}>
                            <video controls>
                            ...
                            <div class="video-col-tx">
                                <div className="channel-icon">
                                    <img src={v.channel.image} alt="Iscrizione1" />
                                </div>
                                <div>
                                    {v.name}
                                    <br />
                ...
                <div class="video-col-tx">
                    ...
                    <div class="item6">
                        {" "}
                        Il mistero della strana pioggia
                        <br />
                        <br />
                        <div class="description">
                            {" "}
                    ...
                    <div class="item8">
                        {" "}
                        10 gadget imperdibili di Amazon
                        <br />
                        <br />
                        <div class="description">
                            {" "}
                    ...
                    <div class="item12">
                        {" "}
                        20 curiosit&agrave; dal Giappone
                        <br />
                        <br />
                        <div class="description">
                            {" "}
                ...
                <div class="video-col-tx">
                    ...
                    <div class="item6">
                        {" "}
                        10 alimenti con pi&ugrave; vitamina C
                        <br />
                        <br />
                        <div class="description">
                            {" "}
                            Alimenti (Roberto Andrioli)
                            <br />
...
const actions = { videosLoaded };

export default connect(mapStateToProps, actions)(ArticleBar);*/
